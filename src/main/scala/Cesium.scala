...
//  }
  ...
  class JulianDate() extends js.Object {
    ...
    var secondsOfDay: Double = js.native //[PR]
  ...
  class Scene protected() extends js.Object {
    ...
    def drillPick(windowPosition: Cartesian2, limit: Double = ???): js.Array[js.Dynamic] = js.native
  ...
  object Cesium extends js.Object {
    ...
    /**
      ...
      * }));
      */
    def createOsmBuildings(options: js.Dynamic = null): Cesium3DTileset = js.native
  }
